...
namespace FIAP_Cloud_Games.Tests.Application.Inputs.JogoInputs
{
    internal class JogoAlteracaoInputTests
    {
        ...
        {
            var input = new JogoAlteracaoInput { Id = _faker.Random.Number(), Titulo = _faker.Name.FullName(), Produtora = _faker.Company.CompanyName() };
        ...
        {
            var input = new JogoAlteracaoInput { Id = 1, Titulo = null!, Produtora = _faker.Company.CompanyName() };
            var results = ValidateModel(input);
        ...
        {
            var input = new JogoAlteracaoInput { Id = 1, Titulo = _faker.Name.FullName(), Produtora = null! };
            var results = ValidateModel(input);
