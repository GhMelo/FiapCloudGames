...
namespace FIAP_Cloud_Games.Tests.Application.Inputs.JogoInputs
{
    internal class JogoCadastroInputTests
    {
        ...
        {
            var input = new JogoCadastroInput { Titulo = null!, Produtora = _faker.Company.CompanyName() };
            var results = ValidateModel(input);
        ...
        {
            var input = new JogoCadastroInput { Titulo = _faker.Name.FullName(), Produtora = null! };
            var results = ValidateModel(input);
